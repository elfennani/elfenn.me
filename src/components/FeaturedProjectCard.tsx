  ...
  return (
    ...
    >
      {index == 0 ? (
        ...
        <div className="absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 -z-20 size-96 md:size-[720px]">
          <VectorBackground2 />
        </div>
      )}
      <span className="leading-none font-display self-start text-3xl sm:text-4xl md:text-6xl font-bold tracking-tighter text-secondary relative after:absolute after:-right-4 sm:after:-right-8 after:top-1/2 after:-translate-y-1/2 after:size-1.5 sm:after:size-2 after:bg-primary after:rounded-full">
      ...
      <div className="flex gap-2 flex-wrap">
        {project.client_work && (
          <span className="text-xs font-[650] tracking-wide px-2 h-6 sm:px-3 sm:h-8 flex items-center justify-center text-center rounded-full bg-slate-100 dark:bg-slate-900 text-secondary">
            Client Work
          </span>
        )}
        {project.in_progress && (
          <span className="text-xs font-[650] tracking-wide px-2 h-6 sm:px-3 sm:h-8 flex gap-2 items-center justify-center text-center rounded-full bg-emerald-50 text-primary dark:bg-emerald-900">
      ...
      <p className="text-sm md:text-base lg:text-lg leading-5 md:leading-6 lg:leading-7 text-muted">
        {project.description}
      </p>
    </div>
  )
